            ...
            >
                ...
                <form onSubmit={handleSubmit}
                    ...
                    <footer className="p-6 flex justify-end gap-4 border-t border-[var(--panel-border)] sm:px-4 md:px-6 lg:px-8">
                        <button type="button" onClick={(e) => { e.preventDefault(); onClose(); }} className="mobile-touch-target px-4 py-3 bg-transparent border border-[var(--panel-border)] text-[var(--text-secondary)] font-bold rounded-lg hover:bg-white/10 transition-colors sm:px-4 md:px-6 lg:px-8">
                            Cancel
                        </button>
                        <button
                            type="submit"
...
const CreateLeagueModalWithErrorBoundary: React.FC = (props) => (
  <ErrorBoundary>
