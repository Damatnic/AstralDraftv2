    ...
    if (this.state.hasError) {
      ...
      return (
        <motion.div 
          ...
          className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-slate-900 to-gray-900 p-4 sm:px-4 md:px-6 lg:px-8"
        >
          <div className="glass-card max-w-md w-full text-center space-y-6 p-8 sm:px-4 md:px-6 lg:px-8">
            <motion.div
              animate={{ rotate: [0, 360] }}
              transition={{ duration: 2, repeat: Infinity, ease: "linear" }}
              className="w-16 h-16 mx-auto border-4 border-red-500/30 border-t-red-500 rounded-full sm:px-4 md:px-6 lg:px-8"
            />
            ...
            <div className="space-y-4 sm:px-4 md:px-6 lg:px-8">
              ...
              {process.env.NODE_ENV === 'development' && this.state.error && (
                <details className="text-left text-xs bg-red-900/20 rounded p-3 border border-red-500/20 sm:px-4 md:px-6 lg:px-8">
                  ...
                  <pre className="mt-2 text-red-300 whitespace-pre-wrap sm:px-4 md:px-6 lg:px-8">
            ...
            <div className="flex space-x-3 sm:px-4 md:px-6 lg:px-8">
              <button
                ...
                className="flex-1 btn-primary sm:px-4 md:px-6 lg:px-8"
...
const SmartErrorBoundaryWithErrorBoundary: React.FC = (props) => (
  <ErrorBoundary>
    <SmartErrorBoundary {...props} />
  </ErrorBoundary>
);

export default React.memo(SmartErrorBoundaryWithErrorBoundary);