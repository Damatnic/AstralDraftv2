...
export const PremiumNavigation: React.FC<NavigationProps> = ({
  currentView,
  onViewChange,
  userName = 'Guest',
  teamName = 'My Team',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                <div className="relative">
                  <div className="w-12 h-12 bg-gradient-to-br from-primary-500 to-primary-700 rounded-2xl flex items-center justify-center shadow-2xl shadow-primary-500/30">
                    <span className="text-2xl">🏈</span>
                  </div>
                  <div className="absolute -bottom-1 -right-1 w-3 h-3 bg-emerald-500 rounded-full animate-pulse shadow-lg shadow-emerald-500/50" />
                </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <motion.button 
                className="relative p-2.5 rounded-xl glass-card hover:bg-white/10 transition-all"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
  ...
  return (
    <div className="relative">
      <motion.button
        ...
        className="flex items-center gap-3 px-3 py-2 rounded-xl glass-card hover:bg-white/10 transition-all"
      ...
      <AnimatePresence>
        {dropdownOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="absolute right-0 mt-2 w-56 glass-panel rounded-xl overflow-hidden shadow-2xl"
          >
            <div className="p-2">
              <button className="w-full px-4 py-2 text-left text-sm text-gray-300 hover:bg-white/10 rounded-lg transition-colors">
                Profile Settings
              </button>
              <button className="w-full px-4 py-2 text-left text-sm text-gray-300 hover:bg-white/10 rounded-lg transition-colors">
                Team Settings
              ...
              <button 
                onClick={onLogout}
                className="w-full px-4 py-2 text-left text-sm text-red-400 hover:bg-red-500/10 rounded-lg transition-colors"
              >
                Sign Out
              </button>
            </div>
