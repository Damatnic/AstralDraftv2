                ...
                <div className="flex items-center gap-3 min-w-0 flex-1 sm:px-4 md:px-6 lg:px-8">
                    ...
                    <div className="min-w-0 flex-1 sm:px-4 md:px-6 lg:px-8">
                        <div className="flex items-center gap-2 sm:px-4 md:px-6 lg:px-8">
                            <h4 className="font-semibold text-[var(--text-primary)] truncate sm:px-4 md:px-6 lg:px-8">{player.name}</h4>
                            {isStarter && <StarIcon className="w-4 h-4 text-yellow-500 sm:px-4 md:px-6 lg:px-8" />}
                        </div>
                    ...
                    <div className="p-4 sm:px-4 md:px-6 lg:px-8">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                            <div className="text-center p-3 bg-blue-500/20 rounded-lg sm:px-4 md:px-6 lg:px-8">
                                <div className="text-2xl font-bold text-blue-400 sm:px-4 md:px-6 lg:px-8">{team.roster.length}</div>
                                <div className="text-xs text-gray-400 sm:px-4 md:px-6 lg:px-8">Total Players</div>
                            </div>
                            <div className="text-center p-3 bg-green-500/20 rounded-lg sm:px-4 md:px-6 lg:px-8">
                                <div className="text-2xl font-bold text-green-400 sm:px-4 md:px-6 lg:px-8">{currentStarters}/{totalStarters}</div>
                                <div className="text-xs text-gray-400 sm:px-4 md:px-6 lg:px-8">Starters Set</div>
                            </div>
                            <div className="text-center p-3 bg-purple-500/20 rounded-lg sm:px-4 md:px-6 lg:px-8">
                                ...
                                <div className="text-xs text-gray-400 sm:px-4 md:px-6 lg:px-8">Total Projection</div>
                            </div>
                            <div className="text-center p-3 bg-yellow-500/20 rounded-lg sm:px-4 md:px-6 lg:px-8">
                                <div className="text-2xl font-bold text-yellow-400 sm:px-4 md:px-6 lg:px-8">{team.budget || 0}</div>
                                <div className="text-xs text-gray-400 sm:px-4 md:px-6 lg:px-8">Remaining Budget</div>
                            </div>
                        </div>
                        ...
                        {canEdit && (
                            <div className="flex gap-2 sm:px-4 md:px-6 lg:px-8">
                                <button
                                    onClick={addPlayer}
                                    className="flex items-center gap-2 px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg sm:px-4 md:px-6 lg:px-8"
                    ...
                    {selectedPlayer && (
                        ...
                        >
                            <motion.div
                                ...
                                className="bg-[var(--panel-bg)] border border-[var(--panel-border)] rounded-lg shadow-xl p-6 max-w-2xl w-full max-h-[80vh] overflow-y-auto sm:px-4 md:px-6 lg:px-8"
                            >
                                <div className="flex items-center justify-between mb-4 sm:px-4 md:px-6 lg:px-8">
                                    <h3 className="text-xl font-bold text-[var(--text-primary)] sm:px-4 md:px-6 lg:px-8">{selectedPlayer.name}</h3>
                                    <button
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <h4 className="font-semibold text-[var(--text-primary)] mb-2 sm:px-4 md:px-6 lg:px-8">Basic Info</h4>
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-[var(--text-primary)] mb-2 sm:px-4 md:px-6 lg:px-8">Statistics</h4>
                                        <div className="space-y-2 text-sm sm:px-4 md:px-6 lg:px-8">
...
export default React.memo(EnhancedRosterManagerWithErrorBoundary);
