      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-dark-800/90 to-transparent"></div>
            
            <div className="absolute top-4 right-4">
              <button
                onClick={onClose}
                className="w-8 h-8 bg-black/30 hover:bg-black/50 rounded-lg flex items-center justify-center text-white/80 hover:text-white transition-colors"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
            ...
            <div className="absolute bottom-4 left-6">
              <div className="flex items-end gap-4">
                <div className="relative">
                  <div className="w-20 h-20 bg-gradient-to-br from-primary-400 to-primary-600 rounded-xl flex items-center justify-center text-white font-bold text-2xl border-4 border-dark-800">
                    {profileData.displayName.charAt(0).toUpperCase()}
                  </div>
                  {isEditing && (
                    <button className="absolute -bottom-2 -right-2 w-8 h-8 bg-primary-500 hover:bg-primary-600 rounded-full flex items-center justify-center text-white">
                ...
                <div className="pb-2">
                  ...
                  <p className="text-primary-300">{profileData.teamName}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="border-b border-white/10 bg-dark-900/50">
            <div className="flex px-6 gap-1">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-3 text-sm font-medium text-gray-400 hover:text-primary-400 transition-colors"
              >
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="bg-dark-700/50 rounded-xl p-4 text-center">
                      <div className="text-2xl font-bold text-primary-400">{currentSeasonStats.rank}</div>
                      <div className="text-sm text-gray-400">Current Rank</div>
                    </div>
                    <div className="bg-dark-700/50 rounded-xl p-4 text-center">
                      <div className="text-2xl font-bold text-green-400">{currentSeasonStats.wins}-{currentSeasonStats.losses}</div>
                      <div className="text-sm text-gray-400">Record</div>
                    </div>
                    <div className="bg-dark-700/50 rounded-xl p-4 text-center">
                      <div className="text-2xl font-bold text-blue-400">{currentSeasonStats.pointsFor}</div>
                      <div className="text-sm text-gray-400">Points For</div>
                    </div>
                    <div className="bg-dark-700/50 rounded-xl p-4 text-center">
                      <div className="text-2xl font-bold text-yellow-400">{currentSeasonStats.tradesCompleted}</div>
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        {isEditing ? (
                          ...
                          <p className="text-white">{profileData.favoriteTeam}</p>
                        )}
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-dark-700/50 rounded-xl p-6">
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between">
                          ...
                          <span className="text-white font-medium">{currentSeasonStats.wins}-{currentSeasonStats.losses}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-400">Points For</span>
                          <span className="text-white font-medium">{currentSeasonStats.pointsFor}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-400">Points Against</span>
                          <span className="text-white font-medium">{currentSeasonStats.pointsAgainst}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-400">Best Week</span>
                          <span className="text-green-400 font-medium">{currentSeasonStats.bestWeek}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-400">Worst Week</span>
                          <span className="text-red-400 font-medium">{currentSeasonStats.worstWeek}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-dark-700/50 rounded-xl p-6">
                      ...
                      <div className="space-y-3">
                        <div className="flex justify-between">
                          <span className="text-gray-400">Trades Completed</span>
                          <span className="text-white font-medium">{currentSeasonStats.tradesCompleted}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-400">Waiver Claims</span>
                          <span className="text-white font-medium">{currentSeasonStats.waiverClaims}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-400">Current Rank</span>
                          <span className="text-primary-400 font-medium">#{currentSeasonStats.rank} of {currentSeasonStats.totalTeams}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="bg-dark-700/50 rounded-xl overflow-hidden">
                    <div className="p-4 border-b border-white/10">
                      <h3 className="text-lg font-semibold text-white">Season History</h3>
                    </div>
                      ...
                      <table className="w-full">
                        <thead>
                          <tr className="bg-dark-600/50">
                            ...
                            <th className="px-4 py-3 text-left text-sm font-medium text-gray-300">Record</th>
                            <th className="px-4 py-3 text-left text-sm font-medium text-gray-300">Finish</th>
                            <th className="px-4 py-3 text-left text-sm font-medium text-gray-300">Points</th>
                            <th className="px-4 py-3 text-left text-sm font-medium text-gray-300">Champion</th>
                          </tr>
                        </thead>
                        <tbody>
